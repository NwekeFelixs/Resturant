...
import footerBg from  '../components/img/footer-bg.jpg';


const Footer = () => {
  return (
    <footer className="footer section has-bg-image text-center" style={{ backgroundImage: "url('../components/img/footer-bg.jpg')" }}>
      <div className="container">
        ...
        <div className="footer-bottom">
          <p className="copyright">
            ...
            <a href="https://github.com/codewithsadee" target="_blank" className="link">
              Feylicks
            </a>
          </p>
        </div>
